        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <ul>
              ...
              <li <?php if(get_post_type() == 'program' or is_page('programs')) echo 'class="current-menu-item"' ?> >
          ...
          <div class="site-header__util">
            <?php if(is_user_logged_in()) { ?>
              ...
              <a href="<?php echo wp_logout_url() ?>" class="btn btn--small btn--dark-orange float-left button--with-photo">
